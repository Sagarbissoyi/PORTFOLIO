...
const Header=()=>{
    ...
    return(
           <nav className={`flex ${show?"translate-y-0":"-translate-y-28"} ${shadow?"shadow-[0px_10px_30px_-10px_#020clb]":""} transition-transform duration-500 ease-in-out fixed w-full z-10 bg-bgColor h-28 px-10 dm-mono-regular justify-between items-center xs-mx:px-4 xs-mx:h-20`}>
